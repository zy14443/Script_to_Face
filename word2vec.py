...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  8 10:49:32 2019
...
with open('word_unique.csv') as csvDataFile:
    csvReader = csv.reader(csvDataFile)
    for row in csvReader:
        word_unique.append(row[0])

word_in_dict = list(set(word_cmu).intersection(word_unique))